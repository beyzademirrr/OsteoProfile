...
- **profil** — Biyolojik profil *(sex · stature · age-at-death)*

> 🔍 **Kritik bilimsel bulgu:** Klasik Trotter-Gleser White formülleri Türk bireylerde ortalama **+4 cm aşırı tahmin** yapar (*Duyar & Pelin, 2003 — J Forensic Sci*). Osteoprofil, Türk/Anadolu örneklemleriyle valide edilmiş katsayıları kullanarak bu sistematik hatayı ortadan kaldırır.
...
```bash
# 1. Depoyu klonla
git clone https://github.com/<kullanici-adi>/osteoprofil.git
cd osteoprofil
...
> **Osteoprofil yalnızca eğitim ve araştırma amaçlıdır.**
...
Eğer Osteoprofil'i akademik çalışmanızda kullanırsanız, lütfen şu şekilde atıf yapın:

```bibtex
@software{osteoprofil2026,
  title  = {Osteoprofil: Adli Antropolojik Biyolojik profil Analiz Platformu},
  author = {<Yazar Adı>},
  year   = {2026},
  url    = {https://github.com/<kullanici-adi>/osteoprofil},
...
**Osteoprofil ile iskelet kalıntıları hikayelerini anlatır.**

⭐ *Projeyi beğendiyseniz yıldızlamayı unutmayın!* ⭐

---

<sub>© 2026 Osteoprofil · MIT Licensed · Made with 🦴 for forensic science</sub>
